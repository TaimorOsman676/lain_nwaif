      ...
      >
        <div className="w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-4 md:gap-6 flex-wrap">
            <a href="tel:+966530985071" className="flex items-center gap-1.5 hover:text-brand-yellow transition-colors no-underline text-white/90 font-medium">
            ...
            <a href="https://wa.me/966530985071" target="_blank" rel="noopener noreferrer" className="flex items-center gap-1.5 hover:text-green-400 transition-colors no-underline text-white/90 font-medium">
