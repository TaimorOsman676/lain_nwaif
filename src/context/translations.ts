  ...
  ar: {
    ...
    faq: {
      ...
      list: [
        ...
        { q: "ما هي المناطق الجغرافية التي تغطيها خدماتكم حالياً؟", a: "نغطي مدينة الرياض العاصمة، محافظة الخرج بالكامل، ومناطق ومحافظات المنطقة الوسطى بالمملكة العربية السعودية." }
      ]
    },
    ctaBlock: {
    ...
    aboutPage: {
      ...
      subtitle: "مسيرة ممتدة من المقاولات الميكانيكية وتصنيع مجاري الهواء في الرياض والخرج",
    ...
    projectsPage: {
      ...
      list: [
        ...
        { title: "مصنع ومستودعات أدوية - المدينة الصناعية", category: "industrial", desc: "أنظمة تهوية صناعية وفلاتر تنقية الهواء مع مكيفات شيلر عملاقة لتثبيت درجات الحرارة للمخازن.", location: "الخرج - المنطقة الصناعية" },
  ...
  en: {
    ...
    faq: {
      ...
      list: [
        ...
        { q: "Which geographical areas in Saudi Arabia do you cover?", a: "Our division currently covers Riyadh City, Al-Kharj Province, and all surrounding areas of the Central Region." }
      ]
    },
    ctaBlock: {
    ...
    aboutPage: {
      ...
      subtitle: "A legacy of electromechanical contracting and duct fabrication in Riyadh and Al-Kharj",
    ...
    projectsPage: {
      ...
      list: [
        ...
        { title: "Pharmaceutical Cold Chain - Industrial Zone", category: "industrial", desc: "Mechanical fresh-air injection, heavy-duty ventilation ducts, and massive chiller setups to lock in climate parameters.", location: "Al-Kharj - Industrial Zone" },
