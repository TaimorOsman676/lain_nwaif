export const translations: Record<string, any> = {
  ar: {
    ...
    hero: {
      ...
      subtitle: "نقدم حلول التكييف المتكاملة، تركيبات الدكت، وأنظمة التهوية المصممة هندسياً للمشاريع السكنية والتجارية والحكومية في الرياض. ضمان معتمد ومطابق لكود البناء السعودي وكفاءة الطاقة ورؤية المملكة 2030.",
      ctaCall: "اتصل الآن",
      ctaContact: "تواصل معنا",
      guarantees: [
        { title: "ضمان معتمد ١٠٠٪", desc: "على كافة أعمال تصنيع الدكت والتركيبات الميكانيكية" },
        { title: "تنفيذ سريع وقياسي", desc: "التزام تام بجداول تسليم المشاريع دون تأخير" },
        { title: "مهندسون معتمدون", desc: "خبرات مؤهلة وفق معايير الجمعية الأمريكية لمهندسي التكييف (ASHRAE)" }
      ],
      descTitle: "تصميم هندسي متكامل",
      descSub: "أعلى معايير جودة توزيع وتدفق الهواء للتكييف المخفي والمركزي."
    },
    stats: [
      { number: "+٥٠٠", label: "مشروع منجز بنجاح" },
      { number: "+١٠", label: "سنوات من التميز الهندسي" },
      { number: "١٠٠٪", label: "رضا العملاء وضمان الجودة" },
      { number: "+٣٠٠", label: "عميل تجاري نشط" }
    ],
    services: {
      title: "خدمات التكييف والتهوية",
      subtitle: "حلول إلكتروميكانيكية وتكييف متكاملة تلبي جميع متطلبات المشاريع في الرياض",
      filterAll: "الكل",
      filterCommercial: "تكييف تجاري",
      filterResidential: "تكييف سكني",
      filterSupport: "خدمات الدعم",
      viewDetails: "تفاصيل الخدمة والمواصفات",
      items: {
        vrf: {
          title: "أنظمة التكييف المتغير VRF / VRV",
          category: "commercial",
          shortDesc: "تكييف VRF متطور يوفر حتى 30% من الكهرباء لمجمعات الرياض. نوفر تخطيطاً هندسياً للوحدات الموزعة من سامسونج، دايكين، وإل جي مع تحكم ذكي مستقل.",
          extendedContent: [
            {
              heading: "تركيب وتوريد أنظمة تكييف VRF/VRV بالرياض",
        ...
        central: {
          ...
          extendedContent: [
            {
              heading: "مقاولات التكييف المركزي للمشاريع بالرياض",
        ...
        concealed: {
          ...
          extendedContent: [
            {
              heading: "تركيب تكييف مخفي دكت سبليت كاريير بالرياض",
        ...
        split: {
          ...
          extendedContent: [
            {
              heading: "توريد وتركيب مكيفات سبليت جدارية بالرياض",
        ...
        maintenance: {
          ...
          category: "support",
          shortDesc: "عقود صيانة وقائية PPM سنوية وإصلاح طارئ للتكييف المركزي ومكيفات الباكج بالرياض. فحص فريون وغسيل مكثفات بأيدي فنيين معتمدين.",
          extendedContent: [
            {
              heading: "عقود صيانة تكييف سنوية وطوارئ 24/7 بالرياض",
          ...
          extendedContent: [
            {
              ...
              text: "تصميم وتركيب أنظمة شفط وتجديد الهواء للمطابخ التجارية، المطاعم، المصانع، ومواقف السيارات المغلقة بالرياض. نقوم بحساب حجم الهواء المطلوب تجديده هندسياً وتصميم شبكات الدكت المناسبة لسحب الروائح، الأبخرة والحرارة الزائدة، وحقن هواء نقي بديل (Make-up Air) لضمان راحة وسلامة العاملين."
            },
            {
        ...
        design: {
          ...
          category: "commercial",
          shortDesc: "إعداد حسابات الأحمال الحرارية ومخططات التكييف التنفيذية (Shop Drawings) للمشاريع بالرياض وفق كود البناء السعودي ومعايير ASHRAE.",
          extendedContent: [
            {
              heading: "تصميم وحساب أحمال التكييف الهندسي لمشروعك بالرياض",
        ...
        duct: {
          ...
          extendedContent: [
            {
              heading: "تصنيع مجاري الهواء (الدكت) في ورش مؤسستنا بالرياض",
        ...
        packaged: {
          ...
          extendedContent: [
            {
              heading: "تركيب وصيانة مكيفات الباكج المركزية بالرياض",
    ...
    whyUs: {
      title: "لماذا تختارنا",
      subtitle: "نتميز بالالتزام بالمعايير الهندسية ودقة التنفيذ",
      items: [
        {
          title: "مرخصون ومعتمدون",
          desc: "مؤسسة وطنية مرخصة ومصنفة رسمياً لتنفيذ المقاولات الميكانيكية والإلكتروميكانيكية بالكامل."
        },
        {
          title: "خدمة طوارئ 24/7",
          desc: "فريق طوارئ هندسي مستعد لمعالجة أي توقف مفاجئ لأنظمة التبريد الحساسة على مدار الساعة."
        },
        {
          title: "زيارة فنية واستشارة مجانية",
          desc: "نقوم بدراسة المخططات وزيارة موقع المشروع مجاناً لتقديم التقييم الفني وحساب الأحمال بدقة."
        },
        {
          title: "ضمان شامل وحقيقي",
          desc: "نوفر شهادة ضمان شاملة على أعمال مجاري الهواء والتركيبات الميكانيكية والتشغيل."
        }
      ]
    },
    testimonials: {
      title: "آراء شركائنا وعملائنا",
      subtitle: "الالتزام بأعلى المعايير ينعكس في تقييمات عملائنا في مختلف القطاعات",
      list: [
        { name: "أحمد الشمري", date: "2025-03-15", comment: "خدمة ممتازة وسرعة في التنفيذ. تم تركيب التكييف المركزي في الفيلا بكل احترافية ومطابقة تامة للمواصفات المعمارية. أنصح بهم بشدة.", source: "Google Review" },
        { name: "محمد العتيبي", date: "2025-02-20", comment: "أفضل مقاول تكييف تعاملت معه في الرياض. الأسعار مناسبة ودقة هندسية عالية جداً في تصنيع الدكت. فريق عمل منظم.", source: "Google Review" },
        { name: "عبدالله الغامدي", date: "2025-01-10", comment: "تم تنفيذ مشروع التكييف المركزي والمخفي في المكتب والمجمع التجاري بشكل ممتاز. التزام بالمواعيد وجودة عالية في التشطيب والتشغيل.", source: "Google Review" },
        { name: "خالد الدوسري", date: "2024-12-05", comment: "عقود صيانة دورية وقائية ممتازة. فريق الصيانة محترف للغاية ويقوم بالفحوصات الدورية بدقة عالية. أسعار ممتازة.", source: "Google Review" },
        { name: "فهد السبيعي", date: "2024-11-18", comment: "تعاملت معهم في مشروع صناعي كبير. تصنيع مجاري الهواء (الدكت) والعوازل بجودة عالية تطابق المواصفات العالمية.", source: "Google Review" },
        { name: "سعد القحطاني", date: "2024-10-22", comment: "خدمة عملاء راقية واستجابة سريعة جداً للأعطال الطارئة. تم إصلاح الخلل الميكانيكي في نفس اليوم بكفاءة بالغة.", source: "Google Review" }
      ]
    },
    faq: {
      title: "الأسئلة الشائعة",
      subtitle: "إجابات هندسية سريعة حول خدمات التكييف والتهوية وتصنيع الدكت",
      list: [
        { q: "ما هي أنواع أجهزة التكييف التي تقومون بتركيبها وتوريدها؟", a: "نقوم بتوريد وتركيب جميع أنواع أنظمة التكييف والتهوية بما في ذلك التكييف المركزي، أنظمة VRF الذكية، التكييف المخفي (دكت سبليت)، الشيلرات العملاقة، ومكيفات الكاسيت والسبليت الجداري." },
        { q: "هل تقدمون ضمان على أعمال التركيب وتصنيع مجاري الهواء؟", a: "نعم، نقدم ضماناً ميكانيكياً شاملاً على جميع أعمال تصنيع الدكت وتركيب العوازل وأعمال التركيب والتشغيل لضمان أعلى مستويات الأداء." },
        { q: "هل تقومون بتصنيع مجاري الهواء (الدكت) في ورش خاصة بكم؟", a: "نعم، تمتلك مؤسسة لين نوايف العقيدي خطوط إنتاج وتصنيع متكاملة ومجهزة بأحدث المعدات لتصنيع مجاري الهواء بمختلف المقاسات وسماكات الصاج المطلوبة هندسياً." },
        { q: "هل توفرون عقود صيانة سنوية للمباني والأبراج والمستودعات؟", a: "نعم، نقدم عقود صيانة وقائية دورية (PPM) وعقود تشغيل متكاملة للمجمعات التجارية والسكنية والمصانع والجهات الحكومية بجدول زيارات منظم." },
        { q: "ما هي المناطق الجغرافية التي تغطيها خدماتكم حالياً؟", a: "نغطي مدينة الرياض العاصمة والمناطق والمدن الصناعية التابعة لها بالمملكة العربية السعودية." }
      ]
    },
    ctaBlock: {
      title: "جاهز لتأسيس وتبريد مساحتك؟",
      subtitle: "احصل على استشارة هندسية وزيارة موقع مجانية اليوم ودع مهندسينا يخططون للحل الأمثل لمشروعك.",
      btn: "اطلب استشارة مجانية الآن"
    },
    partners: {
      title: "شركاء النجاح والعلامات التجارية المعتمدة",
      subtitle: "نتعامل مع أفضل العلامات العالمية الرائدة لتقديم جودة تبريد مستدامة تدوم طويلاً"
    },
    contact: {
      title: "اتصل بنا",
      subtitle: "يسعدنا الإجابة على استفساراتكم الفنية وتقديم عروض أسعار متكاملة لمشاريعكم",
      infoTitle: "بيانات الاتصال والمكتب الرئيسي",
      address: "الرياض، المملكة العربية السعودية",
      phone: "+966 53 098 5071",
      email: "info@lainnwaif.com",
      workingHours: "السبت - الخميس: 8 صباحاً - 6 مساءً",
      friday: "الجمعة: مغلق",
      visionText: "تنمية وطنية متوافقة بالكامل مع رؤية المملكة 2030",
      formName: "الاسم الكامل",
      formEmail: "البريد الإلكتروني",
      formPhone: "رقم الجوال المباشر",
      formSubject: "موضوع الطلب",
      formMessage: "تفاصيل المساحة والمشروع المطلوبة",
      formSubmit: "إرسال الطلب الفني",
      formSuccess: "تم إرسال طلبك بنجاح! سيقوم مهندس المبيعات بالتواصل معك فوراً.",
      formError: "حدث خطأ أثناء الإرسال. يرجى التحقق من المدخلات والمحاولة لاحقاً."
    },
    aboutPage: {
      title: "مؤسسة لين نوايف للتكييف",
      subtitle: "مسيرة ممتدة من المقاولات الميكانيكية وتصنيع مجاري الهواء في الرياض",
      missionTitle: "رسالتنا الفنية",
      missionDesc: "تقديم حلول تكييف وتهوية مبتكرة وتصنيع دكت عالي الكفاءة، يلتزم التزاماً كاملاً بمتطلبات التصاميم المعمارية وحسابات الأحمال الحرارية، لتقليل التكلفة التشغيلية واستهلاك الطاقة.",
      visionTitle: "رؤيتنا المستقبلية",
      visionDesc: "أن نكون المقاول الميكانيكي المعتمد والأكثر موثوقية وجودة في المنطقة الوسطى للمشاريع السكنية والتجارية والحكومية بحلول عام 2030.",
      storyTitle: "قصة التأسيس والريادة",
      storyDesc: "تأسست مؤسسة لين نوايف العقيدي للتكييف ككيان وطني سعودي يسعى لسد الفجوة في قطاع المقاولات الميكانيكية المتخصصة. على مدار السنوات الماضية، قمنا بتنفيذ مئات المشاريع بنجاح باهر، بدءاً من الفلل السكنية الفاخرة والقصور، ووصولاً إلى المولات التجارية والجهات الحكومية ومراكز البيانات الحساسة. نحن فخورون بالمساهمة في بناء البنية التحتية للمملكة وبأن نكون جزءاً فاعلاً في تحقيق مستهدفات رؤية المملكة 2030.",
      valuesTitle: "القيم والمبادئ الحاكمة",
      values: [
        { title: "الالتزام بالمعايير العالمية", desc: "تصنيع وتركيب يلتزم بالكامل بتوصيات كود البناء السعودي ومواصفات SMACNA الهندسية." },
        { title: "الشفافية في الكيل والسمك", desc: "نلتزم بتقديم جداول كميات دقيقة وسمك صاج مجلفن حقيقي يطابق المواصفات المتفق عليها." },
        { title: "الاستدامة وكفاءة التبريد", desc: "تبني ودعم حلول ومعدات صديقة للبيئة وذات استهلاك طاقة مثالي (عوازل حرارية ممتازة)." },
        { title: "دقة وسلامة المواعيد", desc: "جدولة تسليم متوازنة والتنسيق المستمر مع مقاولي المدني والتشطيب لتجنب أي تعارض." }
      ]
    },
    projectsPage: {
      title: "معرض المشاريع والتعاقدات",
      subtitle: "نعتز بثقة عملائنا في المشاريع السكنية والتجارية والحكومية التي قمنا بتنفيذها",
      all: "جميع المشاريع",
      commercial: "مشاريع تجارية",
      residential: "مشاريع سكنية",
      industrial: "مشاريع صناعية وحكومية",
      viewProject: "مواصفات المشروع",
      list: [
        { title: "مشروع تكييف قصر فاخر - حطين", category: "residential", desc: "تصميم وتركيب تكييف مخفي (دكت سبليت) للصالات الكبيرة والغرف مع مجاري هواء معزولة وتوزيع مثالي.", location: "الرياض - حي حطين" },
        { title: "مجمع تجاري وصالات عرض - طريق الملك فهد", category: "commercial", desc: "نظام تكييف مركزي متكامل مع أنظمة تحكم ذكية وصيانة ميكانيكية شاملة لجميع الطوابق.", location: "الرياض - طريق الملك فهد" },
        { title: "مركز بيانات لجهة حكومية - الرياض", category: "industrial", desc: "تركيب وحدات CRAC المتخصصة لغرف السيرفرات مع تحكم دقيق بالرطوبة والحرارة لضمان تشغيل مستمر 99.99%.", location: "الرياض - حي الملز" },
        { title: "فلل سكنية بنظام VRF - حي الملقا", category: "residential", desc: "توريد وتركيب نظام تكييف VRF متطور موفر للطاقة بنسبة 30% مع تشغيل ذكي مستقل لكل غرفة.", location: "الرياض - حي الملقا" },
        { title: "مصنع ومستودعات أدوية - المدينة الصناعية بالرياض", category: "industrial", desc: "أنظمة تهوية صناعية وفلاتر تنقية الهواء مع مكيفات شيلر عملاقة لتثبيت درجات الحرارة للمخازن.", location: "الرياض - المنطقة الصناعية" },
        { title: "مطعم ومقهى راقي - حي الياسمين", category: "commercial", desc: "أنظمة تكييف كاسيت سقفية وتوزيع هواء رباعي الاتجاه مع شفط هواء للمطابخ وحلول تهوية متكاملة.", location: "الرياض - حي الياسمين" }
      ]
    },
    ideasPage: {
      title: "حلول تبريد وأفكار هندسية",
      subtitle: "نشارككم خبراتنا لمساعدتكم في اتخاذ القرارات الصحيحة أثناء تخطيط تكييف مبانيكم",
      readMore: "اقرأ المقالة الكاملة",
      list: [
        {
          id: 1,
          title: "لماذا يعتبر نظام VRF هو المستقبل للتكييف السكني والتجاري؟",
          desc: "دراسة مقارنة توضح كيف تساهم أنظمة التدفق المتغير للفريون (VRF) في توفير الكهرباء بنسبة 30% ومنح مرونة فائقة بالتحكم.",
          date: "2026-05-10",
          author: "م. محمد الحربي"
        },
        {
          id: 2,
          title: "كيف تحافظ على جودة الهواء داخل منزلك مع التكييف المخفي؟",
          desc: "نصائح وإرشادات هندسية لتنظيف الفلاتر ومجاري الهواء بانتظام لضمان هواء نقي وخالٍ من الأتربة والحساسية.",
          date: "2026-04-18",
          author: "فريق الدعم الفني"
        },
        {
          id: 3,
          title: "دليلك لاختيار سعة التكييف المناسبة للغرف والمساحات المفتوحة",
          desc: "طريقة حسابية بسيطة بالأمتار المربعة والارتفاع لمعرفة عدد الوحدات أو الأطنان التبريدية المطلوبة بدقة لتفادي ضعف التبريد.",
          date: "2026-03-05",
          author: "قسم التصميم الهندسي"
        }
      ]
    }
  },
  en: {
    ...
    hero: {
      ...
      subtitle: "Providing turnkey, engineered cooling, duct installations, and complete ventilation infrastructure across residential, commercial, and government sectors in Riyadh. Fully certified, compliant with the Saudi Building Code, and optimized for maximum energy efficiency in alignment with Vision 2030.",
      ctaCall: "Call Now",
      ctaContact: "Contact Us",
      guarantees: [
        { title: "100% Certified Guarantee", desc: "On all duct fabrication and mechanical installations" },
        { title: "Rapid & Punctual Execution", desc: "Strict commitment to project timelines and milestones" },
        { title: "Approved Engineers", desc: "Certified experts in ASHRAE & SMACNA guidelines" }
      ],
      descTitle: "Integrated HVAC Engineering",
      descSub: "Merging air distribution aesthetics with concealed structural energy-efficiency matrices."
    },
    stats: [
      { number: "500+", label: "Projects Completed" },
      { number: "10+", label: "Years of Engineering Excellence" },
      { number: "100%", label: "Client Satisfaction Guarantee" },
      { number: "300+", label: "Active Corporate Accounts" }
    ],
    services: {
      title: "HVAC & Ventilation Services",
      subtitle: "Comprehensive mechanical contracting and engineering cooling solutions in Riyadh",
      filterAll: "All Services",
      filterCommercial: "Commercial HVAC",
      filterResidential: "Residential HVAC",
      filterSupport: "Support Services",
      ...
      items: {
        vrf: {
          ...
          extendedContent: [
            {
              heading: "VRF/VRV System Installation in Riyadh",
        ...
        central: {
          ...
          extendedContent: [
            {
              heading: "Central Package AC Contracting in Riyadh",
        ...
        concealed: {
          ...
          extendedContent: [
            {
              heading: "Concealed Duct Split AC Installation in Riyadh",
          ...
          extendedContent: [
            {
              ...
              text: "We provide structured Planned Preventative Maintenance (PPM) agreements for commercial towers, residential compounds, schools, and industrial warehouses in Riyadh. Regular maintenance protects your mechanical assets, reduces energy bills, and prevents costly emergency shutdowns."
            },
            {
        ...
        ventilation: {
          ...
          extendedContent: [
            {
              heading: "Mechanical Ventilation & Air Extraction in Riyadh",
        ...
        design: {
          ...
          extendedContent: [
            {
              heading: "HVAC Load Calculation & System Design in Riyadh",
        ...
        packaged: {
          ...
          extendedContent: [
            {
              heading: "Rooftop Packaged HVAC Unit Installation in Riyadh",
    ...
    whyUs: {
      ...
      subtitle: "Engineering precision, material transparency, and absolute reliability",
      items: [
        {
          title: "Fully Licensed & Certified",
          desc: "A registered Saudi mechanical engineering contracting firm officially certified for public and private projects."
        },
        {
          title: "24/7 Emergency Support",
          desc: "Dedicated response team standing by around the clock to support critical cold-chain or datacenters."
        },
        {
          title: "Free Technical Site Studies",
          desc: "We analyze load calculations, examine structural prints, and deliver free competitive blueprints."
        },
        {
          title: "Comprehensive Performance Warranty",
          desc: "Real warranties backing up duct fabrication thickness, insulation, and system efficiency."
        }
      ]
    },
    testimonials: {
      title: "Feedback From Our Partners",
      subtitle: "Delivering engineered cooling comfort across industrial, governmental, and private sectors",
      list: [
        { name: "Ahmed Al-Shammari", date: "2025-03-15", comment: "Excellent service and rapid execution. The central AC in my villa was installed with total professionalism, matching structural blueprints perfectly.", source: "Google Review" },
        { name: "Mohammed Al-Otaibi", date: "2025-02-20", comment: "Best HVAC contractor in Riyadh. Extremely competitive prices and high precision in duct fabrication. Professional and neat team.", source: "Google Review" },
        { name: "Abdullah Al-Ghamdi", date: "2025-01-10", comment: "The central ducted systems for our office tower were executed flawlessly. Met project milestones and delivered high-quality air diffusion.", source: "Google Review" },
        { name: "Khaled Al-Dawsari", date: "2024-12-05", comment: "Outstanding preventative maintenance. The technicians are prompt, polite, and provide deep diagnostic sheets during every PPM visit.", source: "Google Review" },
        { name: "Fahad Al-Subaie", date: "2024-11-18", comment: "Partnered on a large factory ventilation layout. Fabrication and gauges of the galvanized sheets matched international standards.", source: "Google Review" },
        { name: "Saad Al-Qahtani", date: "2024-10-22", comment: "Highly responsive customer support. Fixed a sudden chiller breakdown on the same day. Professional diagnosis.", source: "Google Review" }
      ]
    },
    faq: {
      title: "Frequently Asked Questions",
      subtitle: "Clear answers to technical questions about HVAC design, duct fabrication, and installation",
      list: [
        { q: "What types of air conditioning systems do you install and supply?", a: "We supply, design, and install all commercial and residential systems: Central Package Units, VRF systems, Concealed Duct Splits, Water Chillers, Cassette ACs, and Wall Splits." },
        { q: "Do you provide a formal warranty on mechanical contracting works?", a: "Yes, we issue a formal performance warranty covering duct thickness, leakage tests, insulation quality, and commissioning operation." },
        { q: "Do you fabricate galvanized steel ducts in your own workshops?", a: "Yes, Lain Nuawaf Al-Aqeedi Est. owns state-of-the-art sheet metal fabrication workshops, guaranteeing strict quality control on sheet metal gauges and SMACNA standard folds." },
        { q: "Do you provide annual maintenance contracts for large facilities?", a: "Yes, we offer custom Planned Preventative Maintenance (PPM) contracts for corporate offices, malls, government buildings, and cold warehouses." },
        { q: "Which geographical areas in Saudi Arabia do you cover?", a: "Our division currently covers Riyadh City and surrounding metropolitan areas." }
      ]
    },
    ctaBlock: {
      title: "Ready to Cool Your Property?",
      subtitle: "Book a free site survey and load calculation. Let our engineering team design your ideal climate comfort.",
      btn: "Request Free Site Consultation"
    },
    partners: {
      title: "Success Partners & Certified Brands",
      subtitle: "We partner with the world's leading brands to guarantee high-efficiency cooling comfort"
    },
    contact: {
      title: "Contact Us",
      subtitle: "We are ready to provide technical consults and tailored quotes for your HVAC contracts",
      infoTitle: "Main Office & Contact Details",
      address: "Riyadh, Kingdom of Saudi Arabia",
      phone: "+966 53 098 5071",
      email: "info@lainnwaif.com",
      workingHours: "Saturday - Thursday: 8 AM - 6 PM",
      friday: "Friday: Closed",
      visionText: "Fully Aligned with Saudi Vision 2030 Sustainability Goals",
      formName: "Full Name",
      formEmail: "Email Address",
      formPhone: "Direct Phone Number",
      formSubject: "Request Subject",
      formMessage: "Project Dimensions / Message",
      formSubmit: "Send Technical Request",
      formSuccess: "Your request was sent successfully! Our project engineer will contact you shortly.",
      formError: "Error sending request. Please check inputs and try again."
    },
    aboutPage: {
      title: "Lain Nuawaf Al-Aqeedi Est.",
      subtitle: "A legacy of electromechanical contracting and duct fabrication in Riyadh",
      missionTitle: "Engineering Mission",
      missionDesc: "To deliver high-performance HVAC systems and custom duct fabrication that complies fully with the Saudi Building Code, reducing operational energy costs and ensuring long-term structural reliability.",
      visionTitle: "Corporate Vision",
      visionDesc: "To be recognized as the premier mechanical engineering contractor in the Central Region, setting benchmark standards for HVAC execution by 2030.",
      storyTitle: "Our History & Leadership",
      storyDesc: "Lain Nuawaf Al-Aqeedi Est. was founded as a dedicated Saudi contractor to provide engineered mechanical cooling solutions. Over the past decade, we have successfully handed over hundreds of HVAC projects, ranging from custom residential estates to commercial high-rises and secure government data centers. We take pride in building the infrastructure of the Kingdom in alignment with Saudi Vision 2030.",
      valuesTitle: "Core Operating Values",
      values: [
        { title: "Standard Compliance", desc: "All fabrication and mechanical designs fully meet SMACNA and ASHRAE regulations." },
        { title: "Material Transparency", desc: "No thickness shortcuts. We deliver authentic sheet metal weight and gauges as agreed." },
        { title: "Energy Sustainability", desc: "Designing thermal-efficient zoning and eco-friendly refrigerants to minimize footprint." },
        { title: "Punctual Delivery", desc: "Coordinating closely with architectural and concrete contractors to prevent project delays." }
      ]
    },
    projectsPage: {
      title: "Project Portfolio & Contracts",
      subtitle: "Explore our recently completed commercial, residential, and governmental HVAC installations",
      all: "All Projects",
      commercial: "Commercial Contracts",
      residential: "Residential Estates",
      industrial: "Industrial & Government",
      viewProject: "Project Details",
      list: [
        { title: "Luxury Private Palace - Hittin District", category: "residential", desc: "Concealed Duct Split AC integration featuring linear slot diffusers custom integrated with modern gypsum drop ceiling profiles.", location: "Riyadh - Hittin" },
        { title: "Commercial Complex & Tower - King Fahd Road", category: "commercial", desc: "Design and installation of a high-capacity VRF system (320 Tons) with centralized controls and customized branch pipe distribution.", location: "Riyadh - King Fahd Rd" },
        { title: "Government Agency Data Center - Riyadh Zone", category: "industrial", desc: "Installation of specialized CRAC server cooling units with precise humidity controls for continuous 99.99% uptime.", location: "Riyadh - Al-Malaz" },
        { title: "Residential Villa Cluster with VRF - Al-Malqa", category: "residential", desc: "Supply and installation of advanced energy-saving VRF system saving 30% electricity with independent room controls.", location: "Riyadh - Al-Malqa" },
        { title: "Pharmaceutical Cold Chain - Riyadh Industrial Zone", category: "industrial", desc: "Mechanical fresh-air injection, heavy-duty ventilation ducts, and massive chiller setups to lock in climate parameters.", location: "Riyadh - Industrial Zone" },
        { title: "Spacious Fine Dining Restaurant - Al-Yasmin", category: "commercial", desc: "Integrated Cassette units, customized 4-way flow distribution, high-volume kitchen hoods, and air makeup ventilation systems.", location: "Riyadh - Al-Yasmin" }
      ]
    },
    ideasPage: {
      title: "Climate Solutions & Technical Insights",
      subtitle: "Technical articles to help you make informed decisions during your building layout planning",
      readMore: "Read Full Article",
      list: [
        {
          id: 1,
          title: "Why VRF is the Future of Residential and Commercial Air Conditioning",
          desc: "A comparative study showing how Variable Refrigerant Flow (VRF) systems save 30% on electricity bills and provide unmatched control flexibility.",
          date: "2026-05-10",
          author: "Eng. Mohammed Al-Harbi"
        },
        {
          id: 2,
          title: "How to Keep Your Indoor Air Quality High with Concealed AC Systems",
          desc: "Engineering tips and guidelines for regularly cleaning filters and ducts to ensure clean air free of dust and allergens.",
          date: "2026-04-18",
          author: "Technical Support Team"
        },
        {
          id: 3,
          title: "Your Guide to Choosing the Right AC Capacity for Rooms and Open Spaces",
          desc: "A simple mathematical method based on square meters and height to calculate the exact BTUs or cooling tons required to avoid weak cooling.",
          date: "2026-03-05",
          author: "Engineering Design Dept"
        }
      ]
    }
  }
